...
```{r, fig.cap="Figure 1. The majority of people in this dataset (53319) received foodstamps in 2019 whereas only 3823 people do not receive foodstamps in that same year."}
count <- data %>%
  group_by(FOODSTMP) %>%
  summarise(total = n())
